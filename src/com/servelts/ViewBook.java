...
public class ViewBook extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(BookBean bean:list){
			out.println("<tr><td>"+bean.getIsbnno()+"</td><td>"+bean.getAuthor()+"</td><td>"+bean.getAuthor()+"</td><td>"+bean.getPublisher()+"</td><td>"+bean.getQuantity()+"</td><td>"+bean.getIssued()+"</td><td><a href='DeleteBook?callno="+bean.getIsbnno()+"'>Delete</a></td></tr>");
		}
		out.println("</table>");
